...
## Done means
Deployed on a Node host behind HTTPS with `NODE_ENV=production`, `JWT_SECRET`, `RESEND_API_KEY`, `OWNER_EMAIL`, `ALLOWED_ORIGINS` set; `npm test` green (41 checks); `docs/SHIP-CHECKLIST.md` fully checked.
